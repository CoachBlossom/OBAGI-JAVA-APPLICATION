public class Operators{
    public static void main(String[] args){
	   ...
	   boolean isLesThanOrEqualTo = num1 <= num2;
	   ...
	   System.out.printf("The qoutient of num1 and num2 is %f%n",quotient);
	   ...
	   System.out.printf("Is %d < %d? %b%n",num1,num2,isLesThanOrEqualTo);
	   System.out.printf("Is %d < %d? %b%n",num1,num2,isLesThanOrEqualTo);
