public class PrintMethod{
   public static void main(String[] args){
    ...
    //using the println()
       System.out.println();
       System.out.println("I want o tell you that java is different from javascript");
	   System.out.println("\t this is the indented text");
	   
	   //using the printf()
	   System.out.printf("My name is %s and I love %s. Good day everyone %n","Blossom", "Java");
